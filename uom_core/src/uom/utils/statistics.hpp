...
#include "uom/utils/accumulator.hpp"
...
// DebugStatsCollector distance_stat("Distance measurement");
// distance_stat.AddSample(my_distance);
//
// std::cout << Statistics::Print();
...
private:
    ...
    typedef std::vector<StatisticsMapValue> list_t;
