...
class ConcretePacketStream {
 public:
  void AppendPacket(PipelinePayload* new_packet);
  const PipelinePayload* GetPacket(size_t packet_number) const;
...
class MockPacketStream {
 public:
  MOCK_CONST_METHOD1(GetPacket, const PipelinePayload*(size_t packet_number));
